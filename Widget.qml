...
BarWidget {
  id: root
  moduleName: "dizziee.cline-model-usage"
  ...
  function iconSource() {
    return Qt.resolvedUrl("assets/cline.svg")
  }
  ...
  function tooltipText() {
    if (!provider) return "Cline Usage"
  ...
  IpcHandler {
    target: "dizziee.cline-model-usage"
  ...
  component EmptyUsageChip: Item {
    ...
    MouseArea {
      ...
      hoverEnabled: true
      cursorShape: Qt.PointingHandCursor
      onEntered: if (root.bar) root.bar.showTooltip(emptyChip, "Cline Usage")
        ...
        Flickable {
          ...
          ColumnLayout {
            ...
            Text {
              ...
              Layout.fillWidth: true
              Layout.topMargin: 24
              text: "No usage data yet. Start an Cline session to see stats."
              color: dim
              font.family: fontFamily
              font.pixelSize: 11
              horizontalAlignment: Text.AlignHCenter
  ...
  component SettingsContent: ColumnLayout {
    ...
    SectionCard {
      ...
      ColumnLayout {
        ...
        Text {
          Layout.fillWidth: true
          text: "How often the widget rescans the cline database."
          color: dim
          font.family: fontFamily
          font.pixelSize: 10
          wrapMode: Text.WordWrap
